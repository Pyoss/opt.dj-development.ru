    ...
    <div class="questions__container container">
        <div class="questions__container-left">
            ...
            <div class="questions__messengers">
                <a href="<?=$GLOBALS['whatsapp_ref']?>"><img class="questions__messengers-items" src="/upload/src/opt/whatsapp_ios.png"></a>
                <a href="<?=$GLOBALS['tg_ref']?>"><img class="questions__messengers-items" src="/upload/src/opt/tg_ios.png"></a>
            </div>
            <div class="questions__text">
